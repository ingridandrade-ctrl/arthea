...
export function CategoriasClient() {
  ...
  async function remove(id: string) {
    ...
    await fetch(`/api/financas/categories/${id}`, { method: "DELETE" });
    load();
  }

  async function toggleArchive(c: Category) {
    await fetch(`/api/financas/categories/${c.id}`, {
      method: "PATCH",
...
function CategoryModal({
  ...
  async function submit(e: React.FormEvent) {
    ...
    setError(null);
    const url = category
      ? `/api/financas/categories/${category.id}`
      : "/api/financas/categories";
